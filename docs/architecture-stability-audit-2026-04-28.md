...
## § ملحق — قرار DATA-002 (2026-04-30) ✅ مُغلق

**تاريخ القرار:** 2026-04-30  
**مصدر التحقق:** API الإنتاج عبر المتصفح (quality.aqiltech.sa) — لا Neon dev  
**Commit التوثيق:** `14c9637`

### الحقيقة المعتمدة (الإنتاج)

| المحور | عدد الأهداف | القرار |
|--------|------------|--------|
| AXIS-01 (الأثر الاجتماعي والمستفيد) | 3 | ✅ رسمي — لا يُمَس |
| AXIS-02 (الاستدامة المالية والتنويع) | 1 | ✅ رسمي — لا يُمَس |
| AXIS-03 (التميز المؤسسي والتحول الرقمي) | 2 | ✅ رسمي — لا يُمَس |
| AXIS-04 (الشراكات ورأس المال البشري) | 2 | ✅ رسمي — لا يُمَس |
| FINANCIAL | 0 | 🔵 بيانات غير مستخدمة — مؤجل |
| CUSTOMER | 0 | 🔵 بيانات غير مستخدمة — مؤجل |
| PROCESS | 0 | 🔵 بيانات غير مستخدمة — مؤجل |
| LEARNING | 0 | 🔵 بيانات غير مستخدمة — مؤجل |
| GOVERNANCE | 0 | 🔵 بيانات غير مستخدمة — مؤجل |

### القرار الرسمي

**نعتمد AXIS-01..04 كمحاور رسمية للخطة الاستراتيجية 2026-2030** — وهي أنسب لجمعيات القطاع الثالث من إطار BSC التجاري.

محاور FINANCIAL/CUSTOMER/PROCESS/LEARNING/GOVERNANCE:
- **موجودة في DB** ولا تُحذف
- **غير مُعتمدة** في الخطة الحالية
- **مؤجلة لقرار إداري لاحق** (قد تُستخدم في تقارير مقارنة أو إطار تحليلي منفصل)

### الخطوات المعتمدة

| المهمة | النوع | الحالة |
|--------|-------|--------|
| AXIS-CLEANUP-001 — إخفاء المحاور الخمس من واجهة التخطيط | UI فقط · لا schema | 🔲 في قائمة الانتظار |

### ما لا يتغير

- ❌ لا حذف للمحاور الخمس
- ❌ لا إعادة ربط الأهداف
- ❌ لا migration
- ❌ لا schema change
- ✅ الأهداف الثمانية تبقى على AXIS-01..04
