...
آخر تحديث: 2026-05-20T16:24:12.196Z
...
- عناصر القائمة: 64
- مجموعات القائمة: 10
- صفحات تعرض بقالب خاص: 45
- صفحات تستخدم عرض القائمة العام: 36
- مراجع الانتقال goto/hash: 26
- أخطاء مانعة: 0
- تنبيهات غير مانعة: 0

## مجموعات القائمة

| المجموعة | العنوان | العدد | الصفحات |
| --- | --- | --- | --- |
| daily | عملي اليومي | 4 | myWork, myKpi, myAcknowledgments, userGuide |
| performance | الأداء والمتابعة | 9 | kpiFollowUp, follow-up-tasks, kpiTracking, progressReports, dataHealth, operationalReports, slaBoard, dashboard, reportBuilder |
| isoCenter | جاهزية ISO | 7 | monthlyReadiness, iso-readiness, isoRequirements, templateLibrary, managementReview, audits, auditChecklists |
| qualityCases | حالات الجودة والتحسين | 7 | complaints, ncr, capa, risks, changeRequests, improvementProjects, surveys |
| planning | الخطة والمؤشرات | 11 | planMap, strategicGoals, operationalActivities, indicators, annualTargets, strategicPlans, axes, initiatives, fundingSources, fundingPlans, planVersions |
| context | السياق والوثائق الحاكمة | 8 | qualityScope, organizationalChart, swot, interestedParties, processes, qualityPolicy, ackDocuments, acknowledgmentsMatrix |
| support | الدعم والموارد البشرية | 5 | documents, training, competence, performanceReviews, communication |
| operation | بيانات التشغيل المرجعية | 4 | beneficiaries, donations, suppliers, programs |
| automation | التنبيهات والتكاملات | 3 | integrationsSettings, consultant, aiSettings |
| settings | إدارة النظام | 5 | users, departments, audit-log, dataImport, portalAdmin |
...
- عناصر في المجموعات وغير موجودة في menu: 0
- عناصر في مصفوفة الأدوار وغير موجودة في menu: 0
- صفحات رئيسية غير موجودة في menu: 0
- أهداف aliases غير موجودة في menu: 0
- روابط goto/hash غير معروفة: 0
- صفحات مستثناة من العرض العام بلا قالب خاص: 0
