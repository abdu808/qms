...
function app() {
  return {
    ...
    menu: [
      ...
      { id: 'ackDocuments',           label: 'وثائق تحتاج إقرار', icon: '📋' },
      { id: 'myAcknowledgments',      label: 'إقراراتي المطلوبة',              icon: '✅' },
      { id: 'acknowledgmentsMatrix',  label: 'تغطية الإقرارات', icon: '🗂️' },
      ...
      { id: 'follow-up-tasks',        label: 'مهام المتابعة',           icon: '📌' },
    ...
    menuGroups: [
      ...
      { id: 'performance',  title: 'الأداء والمتابعة',        icon: '📈', iso: 'ISO 9',    color: 'sky',     items: ['kpiFollowUp','follow-up-tasks','kpiTracking','progressReports','dataHealth','operationalReports','slaBoard','dashboard','reportBuilder'] },
    ...
    _menuItemsForRole(role) {
      ...
      const matrix = {
        ...
        QUALITY_MANAGER: [
          ...
          'fundingSources','fundingPlans','planVersions','operationalActivities','kpiTracking','myKpi','kpiFollowUp','follow-up-tasks','risks',
          'changeRequests',
        ...
        COMMITTEE_MEMBER: [
          ...
          'myAcknowledgments','acknowledgmentsMatrix',
          'strategicPlans','axes','indicators','annualTargets','planMap','strategicGoals','initiatives',
          'fundingSources','fundingPlans','operationalActivities','kpiTracking','myKpi','kpiFollowUp','follow-up-tasks','risks',
          'changeRequests',
          'documents','training','competence','performanceReviews','communication',
          'beneficiaries','donations','programs','suppliers',
          'managementReview','audits','auditChecklists','surveys','complaints','slaBoard','progressReports',
