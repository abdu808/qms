...
function app() {
  return {
    ...
    menu: [
      ...
      { id: 'objectives',             label: 'الأهداف التشغيلية',   icon: '🎯' },
    ...
    guidedMenuGroupsForRole() {
      ...
      const groups = {
        ...
        DEPT_MANAGER: [
          ...
          { id: 'guided-planning', title: 'الخطة والمؤشرات', icon: '🎯', iso: '', color: 'violet', items: ['strategicGoals', 'axes', 'objectives', 'kpiTracking', 'operationalActivities', 'initiatives'] },
          { id: 'guided-help', title: 'المساعدة', icon: '📖', iso: '', color: 'indigo', items: ['userGuide'] },
        ],
        COMMITTEE_MEMBER: [
          ...
          { id: 'guided-planning', title: 'الخطة والمؤشرات', icon: '🎯', iso: '', color: 'violet', items: ['strategicGoals', 'axes', 'objectives', 'kpiTracking', 'initiatives'] },
          { id: 'guided-help', title: 'المساعدة', icon: '📖', iso: '', color: 'indigo', items: ['userGuide'] },
        ],
        QUALITY_MANAGER: [
          ...
          { id: 'guided-planning', title: 'الخطة والمؤشرات', icon: '🎯', iso: '', color: 'violet', items: ['strategicPlans', 'axes', 'strategicGoals', 'objectives', 'indicators', 'myKpi'] },
