...
window.QMS_MODULES_SUPPORT = {
  ...
  performanceReviews: {
    ...
    fields: [
      { key: 'reviewTemplate', label: 'نموذج التقييم الجاهز', type: 'select', applyTemplate: true, hint: 'اختر القالب أولاً ليملأ الفترة والنصوص الإرشادية، ثم اختر الموظف وأكمل الدرجات.', options: [
